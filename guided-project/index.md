...
-   **I finished the project with a lot of time left, what now?**
    -   This is where you can express your creativity and differentiate your project from the others! The [💫 bonus](/guided-project/Bonus.md) page of this guide shows the next steps after completion. A few general options include:
...
-   [⁉️ User Authentication (Firebase)](/guided-project/Backend/user_auth.md)
-   [⛅️ Connecting an API (Weather)](/guided-project/Backend/api.md)
